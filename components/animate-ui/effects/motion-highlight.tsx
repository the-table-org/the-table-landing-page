                        ...
                        <AnimatePresence>
                            {boundsState && (
                                <motion.div
                                    ...
                                    transition={transition}
                                    className={cn('bg-muted z-0', className, activeClassNameState)}
                                />
                            )}
                        </AnimatePresence>
                        {children}
...
function MotionHighlightItem({
    ...
    React.useLayoutEffect(() => {
        ...
        const updateBounds = () => {
            ...
            // Ensure bounds are valid (not zero-sized)
        ...
        // Use double RAF to ensure layout is completely settled before measuring
