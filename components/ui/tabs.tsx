...
function TabsList({
  ...
  return (
    <MotionHighlight
      controlledItems
      className={cn(
        "rounded-lg bg-background shadow-sm shadow-black/15 border border-border/50",
        activeClassName,
      )}
      value={activeValue}
      transition={transition}
    ...
    >
      <TabsPrimitive.List
        ...
        data-slot="tabs-list"
        className={cn(
          "bg-muted text-muted-foreground inline-flex h-10 w-fit items-center justify-center rounded-xl p-[4px] shadow-inner",
          className,
        )}
        {...props}
      >
