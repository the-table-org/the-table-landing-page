...
function SidebarProvider({
    ...
    const { isOpen: persistedOpen, setOpen: setPersistentOpen } = useSidebarStore();
    ...
    const open = React.useMemo(() => {
        ...
        return defaultOpen;
    }, [openProp, isHydrated, persistedOpen, defaultOpen]);
    ...
    const setOpen = React.useCallback(
        (value: boolean | ((value: boolean) => boolean)) => {
            ...
            if (setOpenProp) {
                ...
                setPersistentOpen(openState);
            }
        },
        [setOpenProp, open, isHydrated, setPersistentOpen]
    );
