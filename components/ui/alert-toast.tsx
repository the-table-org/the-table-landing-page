...
const variantIconWrapperStyles: Record<AlertVariant, string> = {
    error: 'bg-destructive !text-destructive-foreground !shadow-[0_0_24px_hsl(var(--destructive)/0.3)]',
    success: 'bg-success !text-success-foreground !shadow-[0_0_24px_hsl(var(--success)/0.3)]',
    warning: 'bg-warning !text-warning-foreground !shadow-[0_0_24px_hsl(var(--warning)/0.3)]',
    info: 'bg-primary !text-primary-foreground !shadow-[0_0_24px_hsl(var(--primary)/0.3)]',
    default: 'bg-muted !text-muted-foreground !shadow-[0_0_24px_hsl(var(--muted)/0.3)]',
};
...
export function AlertToast({ variant = 'default', title, message, icon, duration = 3000, className, onClick, onDismiss }: AlertToastProps) {
    ...
    return (
        <div className={cn('fixed top-8 left-1/2 -translate-x-1/2 z-50 pointer-events-none', className)}>
            <motion.div
                onClick={handleClick}
            ...
            >
                <motion.div
                    ...
                    transition={{
                        width: {
                            duration: isExpanded ? ANIMATION_TIMINGS.EXPAND_DURATION : ANIMATION_TIMINGS.COLLAPSE_DURATION,
                            ease: EASING.smooth,
                ...
                >
                    <div className={cn('flex items-center h-full', isExpanded ? 'gap-3.5' : 'justify-center')}>
                            ...
                            {isExpanded && (
                                <motion.div
                                    ...
                                    transition={{
                                        ...
                                        ease: EASING.smooth,
                                        opacity: { duration: ANIMATION_TIMINGS.TEXT_DURATION * 0.8 },
                                    }}
