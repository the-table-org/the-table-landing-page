    ...
    compoundVariants: [
      ...
      },
      {
        ...
        className: [
          ...
          "hover:shadow-sm hover:shadow-secondary/20",
          "active:scale-95",
        ].join(" "),
      },
      {
        ...
        className: [
          ...
          "hover:shadow-sm hover:shadow-destructive/20",
          "active:scale-95",
        ].join(" "),
      },
      {
        ...
        className: [
          "text-warning",
          "hover:bg-warning/10",
          "hover:shadow-sm hover:shadow-warning/20",
          "active:scale-95",
        ].join(" "),
      },
      {
        ...
        className: [
          "text-success",
          "hover:bg-success/10",
          "hover:shadow-sm hover:shadow-success/20",
          "active:scale-95",
        ].join(" "),
      },
      {
        ...
        className: [
          "text-info",
          "hover:bg-info/10",
          "hover:shadow-sm hover:shadow-info/20",
          "active:scale-95",
        ].join(" "),
      },
...
const Pill = React.forwardRef<HTMLDivElement, PillProps>(
  (
    ...
    return (
      ...
      >
        {icon && (
          <span className="mr-1.5 flex items-center text-current">{icon}</span>
        )}
        {children}
      </Comp>
    );
