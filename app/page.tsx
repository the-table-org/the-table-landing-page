                    ...
                    <div className="mt-8 pt-6 border-t border-border border-dashed">
                        <div className="flex items-center justify-between text-xs text-muted-foreground/60">
                            ...
                            <div className="flex items-center gap-4">
                                <a href="https://www.instagram.com/thetableapp.co/" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                                ...
                                <a href="https://www.linkedin.com/company/thetableapp" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path
