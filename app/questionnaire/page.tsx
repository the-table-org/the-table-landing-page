        ...
        return (
            <div className="h-screen bg-background font-sans flex items-center justify-center p-8 overflow-hidden">
                <div className="flex gap-4 h-[95dvh] w-full">
                    ...
                    {/* Right Side - Loading */}
                    <div
                            className="p-8 flex flex-col justify-center items-center bg-white rounded-3xl w-3/5 border border-border/50">
                            <div
    ...
    return (
        <div className="h-screen bg-background font-sans flex items-center justify-center p-8 overflow-hidden">
            <div className="flex gap-4 h-[95dvh] w-full">
                ...
                <div
                        className="p-8 flex flex-col bg-white rounded-3xl w-3/5 border border-border/50 overflow-hidden">
