    ...
    <div className="min-h-screen bg-background font-sans">
      <div className="max-w-4xl mx-auto px-6 py-12 lg:py-16">
        ...
        <div className="prose prose-neutral max-w-none">
          <div className="space-y-8 text-[15px] leading-[1.7] text-muted-foreground">
            <p>
            ...
            <section>
              ...
              <h3 className="text-xl font-serif font-medium text-foreground mb-3 mt-8">
                Interpretation
              </h3>
              <p>
              ...
              <ul className="space-y-3 list-disc pl-6">
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to The Table.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to The Table, accessible from
                  www.thetableapp.co
                </li>
                <li>
            ...
            <section>
              ...
              <h4 className="text-lg font-serif font-medium text-foreground mb-3 mt-6">
                Personal Data
              </h4>
              <p className="mb-3">
            ...
            <section>
              ...
              <ul className="space-y-4 list-none pl-0 mt-4">
                <li>
                  ...
                  <span className="block text-sm">Type: Session Cookies</span>
                  <span className="block text-sm">Administered by: Us</span>
                ...
                <li>
                  <strong className="block mb-1">Functionality Cookies</strong>
                  <span className="block text-sm">
                    Type: Persistent Cookies
                  </span>
                  <span className="block text-sm">Administered by: Us</span>
